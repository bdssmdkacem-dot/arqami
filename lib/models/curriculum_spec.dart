...
class CurriculumSpecs {
  ...
  static const List<CurriculumSpec> _specs = [
    ...
    CurriculumSpec(learningGoalAr:'مسائل الطرح اللفظية', objectivesAr:['تمييز موقف الطرح','تحديد المطلوب والباقي أو الفرق','تحويل الموقف إلى عملية طرح'], skillsAr:['فهم المسألة','الطرح','التفسير'], activityPlanAr:['درس استراتيجية','تحديد المعطيات','اختيار الطرح','حل مسألة','تفسير الباقي'], activityKinds: [CurriculumActivityKind.lesson, CurriculumActivityKind.wordProblem, CurriculumActivityKind.quiz], finalChallengeAr:'حل موقف واقعي عن الباقي أو الفرق وفسّر إجابتك', estimatedMinutes:11),
    CurriculumSpec(learningGoalAr:'الطرح مع الاستلاف', objectivesAr:['فهم إعادة التجميع في الطرح','حل طرح متعدد الخانات','التحقق من الناتج'], skillsAr:['إعادة التجميع','الحساب','التحقق'], activityPlanAr:['درس بالمكعبات','إعادة التجميع','حساب مباشر','مسألة تطبيقية','تحقق من الإجابة'], activityKinds: [CurriculumActivityKind.lesson, CurriculumActivityKind.arithmetic, CurriculumActivityKind.quiz], finalChallengeAr:'حل مسألة طرح تتطلب إعادة التجميع ثم تحقق من الناتج', estimatedMinutes:12),
    CurriculumSpec(learningGoalAr:'مسائل الجمع اللفظية', objectivesAr:['تمييز موقف الجمع','تحويل الموقف إلى عملية جمع','حساب الناتج وتفسيره'], skillsAr:['فهم المسألة','الجمع','التفسير'], activityPlanAr:['درس استراتيجية','تحديد المعطيات','اختيار الجمع','حل مسألة','تحقق من الإجابة'], activityKinds: [CurriculumActivityKind.lesson, CurriculumActivityKind.wordProblem, CurriculumActivityKind.quiz], finalChallengeAr:'حل موقف واقعي يتطلب جمع كميتين وفسّر الناتج', estimatedMinutes:11),
    ...
    CurriculumSpec(learningGoalAr:'الأعداد العشرية', objectivesAr:['فهم القيمة المكانية بعد الفاصلة','جمع وطرح الأعداد العشرية البسيطة'], skillsAr:['الأعشار','الأجزاء من مئة','الحساب العشري'], activityPlanAr:['درس بصري','تمثيل عشري','حساب','مقارنة','مراجعة'], activityKinds: [CurriculumActivityKind.lesson, CurriculumActivityKind.arithmetic, CurriculumActivityKind.quiz, CurriculumActivityKind.review], finalChallengeAr:'اقرأ أعداداً عشرية وقارنها ثم احسب عملية بسيطة', estimatedMinutes:14),
